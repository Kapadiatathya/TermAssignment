...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response1 = await axios.post(`${REACT_APP_API_ENDPOINT}/contactus`, JSON.stringify(formData)); 
            ...
            const response2 = await axios.post(`${REACT_APP_API_ENDPOINT}/email`, JSON.stringify(emailPayload)); 
                ...
                <div className="container mb-5">
                    ...
                    <div className="row">
                        <div className="col-md-5 d-flex justify-content-center">
                            <img src="/assets/images/contactUs.jpg" alt="Contact Us" height="300px" width="300px" />
                        </div>
